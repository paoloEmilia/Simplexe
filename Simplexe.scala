...
class Simplexe ( aMatrix:Array[Array[Double]] ) {
    ...
    private val _rows:Int = aMatrix.length                                      // To get the number of rows
    private val _cols:Int = aMatrix(0).asInstanceOf[Array[Double]].size         // To get the number of columns
